...
public class ProtectedPrefs {
	...
	private static string secretKey = "vd009million";
	private static byte[] key = new byte[8] {55, 13, 47, 24, 99, 111, 31, 67};
	private static byte[] iv = new byte[8] {15, 28, 44, 30, 88, 12, 8, 217};
